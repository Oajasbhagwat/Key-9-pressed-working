...
********************************************************************************/
#define LCD_BACKGROUND    Colr[0]   //Default background color
...
void GUI_TIMR5(void);
void Test_Port(void); 
void ShowNum2(POINT x1,POINT y1,int32_t N1,sFONT* pFont, COLOR bkc,COLOR penc ); // show an integer ,right-aligned
#endif
